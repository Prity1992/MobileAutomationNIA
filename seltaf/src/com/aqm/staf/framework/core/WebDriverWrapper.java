...
public class WebDriverWrapper {
	...
	public WebDriverWrapper(AppiumDriver driver) {
...
//		Reporter.log(strImg);
	...
	public static String captureScreenShot(AndroidDriver driver, File destinationFilePathLocation, String screenName ) throws IOException {
		String fileName = new String();
		File srcFiler=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		DateFormat dateFormat = new SimpleDateFormat("hh_mm_ssaadd_MMM_yyyy");
		Date date = new Date();
		fileName = screenName + dateFormat.format(date) + ".png";
		
		File destinationFilePath = new File((destinationFilePathLocation + File.separator + fileName));
		FileUtils.copyFile(srcFiler, destinationFilePath);
		//ImageIO.write(image, "png", destinationFilePath);

		Reporter.log("<br> <a target = \"_blank\" href=\"" + destinationFilePath +"\">"+
				"<img src=\""
				+ destinationFilePath 
				+ "\" alt=\"ScreenShot Not Available\" height=\"775\" width=\"400\"> </a>",true);
		return fileName;
	}
