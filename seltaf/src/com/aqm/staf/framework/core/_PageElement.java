...
public class _PageElement {
	...
	public _PageElement(By by, String fieldName) {
		super();
		this.by = by;
		this.fieldname = fieldName;
	}

	public _PageElement(By by, String fieldName, boolean isSlowLoadableComponent, WaitType waitType, int timeOut) {
		super();
		this.by = by;
		this.fieldname = fieldName;
