...
public class ExcelToStringArray implements Cloneable {
			...
			public ArrayList<ArrayList<StringBuilder>> GetSheetInStringArray(String PathtoFilename,String rId) throws Exception{
			...
			public static void main(String[] args) throws Exception {
				...
				generate.GetSheetInStringArray("D:\\Users\\NIA\\Desktop\\DeviceList.xlsx","rId1");
				...
				*/
				...
				System.out.println(InMemoryQuery.getRowDataOnCriteria(
						...
						InMemoryQuery.getRowNumberArrayBasedOnCriteria(generate.stringArrayToReturn,
								...
								new StringBuilder("192.168.1.27")),
						new StringBuilder("0"),
						InMemoryQuery.getRowNumberArrayBasedOnCriteria(generate.stringArrayToReturn,
